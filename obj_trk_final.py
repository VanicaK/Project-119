...
video = cv2.VideoCapture("C:/Users/vijay.LAPTOP-6K2HIQ6S/OneDrive/Desktop/VS Projects Python/project-119/footvolleyball.mp4")
#load tracker 
...
def drawBox(img,bbox):
    ...
    x,y,w,h=int(bbox[0]),int(bbox[1]),int(bbox[2]),int(bbox[3])
    cv2.rectangle(img,(x,y),((x+w),(y+h)),(255,0,255),3,1)
    cv2.putText(img,"TRACKING",(75,90),cv2.FONT_HERSHEY_TRIPLEX,0.7,(0,255,0),2)
    pass
...
while True:
   ...
   if success:
    drawBox(img,bbox)
     ...
     cv2.putText(img,"LOST",(75,90),cv2.FONT_HERSHEY_TRIPLEX,0.7,(0,255,0),2)
   pass
video.release()
